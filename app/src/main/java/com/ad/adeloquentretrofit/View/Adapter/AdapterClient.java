...
public class AdapterClient extends RecyclerView.Adapter<AdapterClient.Holder> {
    ...
    public AdapterClient(List<Musica> musicaList, NavController navController, Activity activity, Context context) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navController.navigate(R.id.action_clienteFragment_to_verMusicaClienteFragment);
            }
        });
    }
